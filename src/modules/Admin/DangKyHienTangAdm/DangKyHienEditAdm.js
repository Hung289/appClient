...
const DangKyHienEditAdm = (props) => {
    ...
    const SignupSchema = Yup.object().shape({
        ...
        ngaydk: Yup.string()
            ...
            .test(
                'len',
                'Ngày đăng ký vượt quá ngày hiện tại',
                (value) => Date(value) <= Date() || value === undefined
            ),
        namdk: Yup.number()
            .nullable()
            .min(1900, 'Năm phải lớn hơn 1900')
            ...
            <>
                ...
                >
                    <Modal.Header closeButton>
                        <Modal.Title>Cập nhật đăng ký hiến tạng</Modal.Title>
                    </Modal.Header>
                    <Modal.Body>
                        <Formik
                            innerRef={formRef}
                            initialValues={{
                                ...
                                ngaydk: CommonUtility.GetDateSetField(
                                    entityObj.NgayDK
                                ),
