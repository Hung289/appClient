...
//                 >
//                     Đăng ký chờ ghép tạng thành công
//                 </p>
//             </div>
//             <Document
//                 file={`${window.location.origin}/Phiếu đăng ký chờ ghép.pdf`}
...
const PDKGhep = (props) => {
    ...
    const SignupSchema = Yup.object().shape({
        ...
        baoHiemYTe: Yup.string()
            .trim()
            .required('Vui lòng nhập thông tin này')
            .max(15, 'Bảo hiểm y tế có tốt đa 15 ký tự')
            .test(
                'len',
        ...
        tienChuanBiChoViecGhepThan: Yup.number()
            ...
            .min(0)
            .typeError('Hãy nhập một số lớn hơn 0'),
        choGhepBenh: Yup.string().trim().required('Vui lòng nhập'),
        choGhepBVDieuTri: Yup.string().trim().required('Vui lòng nhập'),
        email: Yup.string()
            .required('Vui lòng nhập thông tin này')
                ...
                <div className="col-sm-12">
                    <div className="pdk-hien-tieude">
                        <div className="headerClientPage">
                            {IsDone.data.HoTenBN} GỬI ĐƠN ĐĂNG KÝ CHỜ GHÉP{' '}
                            {IsDone.data.TenCoQuan} THÀNH CÔNG{' '}
                        </div>
                    </div>
                    <div>
                        <div className="Bold20">
                            Tổ phụ trách: Tiếp nhận đăng ký cần ghép{' '}
                        ...
                        <div className="paddingleft10">
                            ...
                            <div className="alert alert-warning">
                                <div>
                                    Để hoàn tất quá trình đăng ký vui lòng tải
