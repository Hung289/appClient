...
export const CreateNewEntity = async (obj) => {
    const dataRequst = await fetch(
        `${Constant.PathServer}/api/KQXetNghiemVGC/Create`,
        {
...
export const OpenEditModalSV = (id) => {
    const dataRequst = fetch(
        `${Constant.PathServer}/api/KQXetNghiemVGC/GetById?id=${id}`
    )
        .then((response) => response.json())
        .then((json) => {
            if (json.Status) {
...
export const EditNewEntity = async (obj) => {
    const dataRequst = await UtilRequest.RequestAuth(
        `${Constant.PathServer}/api/KQXetNghiemVGC/Edit`,
        'POST',
        obj
    ).then((rs) => {
        return rs;
...
export const GetKQXetNghiem = async (id) => {
    const data = await fetch(
        `${Constant.PathServer}/api/KQXetNghiemVGC/GetByIdPhieuDK?id=${id}`
    )
        .then((response) => response.json())
        .then((json) => {
            return json;
...
export const LoadEntity = async (objSearch) => {
    ...
    const dataRequst = await UtilRequest.RequestAuth(
        `${Constant.PathServer}/api/KQXetNghiemVGC/GetDanhSach`,
        'POST',
        searchModel
    ).then((rs) => {
        return rs;
...
export const GetDetailById = async (id) => {
    const dataRequst = await UtilRequest.RequestAuth(
        `${Constant.PathServer}/api/KQXetNghiemVGC/GetDtoById?id=${id}`,
        'GET'
    ).then((rs) => {
        return rs;
    });
...
export const DeleteEntity = async (id) => {
    const dataRequst = await UtilRequest.RequestAuth(
        `${Constant.PathServer}/api/KQXetNghiemVGC/Delete?id=${id}`,
        'POST',
        null
    ).then((rs) => {
        return rs;
...
export const DeleteMultiEntity = async (id) => {
    const dataRequst = await UtilRequest.RequestAuth(
        `${Constant.PathServer}/api/KQXetNghiemVGC/DeleteMulti?id=${id}`,
        'POST',
        null
    ).then((rs) => {
        return rs;
