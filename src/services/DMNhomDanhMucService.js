import * as TypeActions from '@app/store/ActionType/DMNhomDanhMucTypeAction';
import {toast} from 'react-toastify';
import * as Constant from '@app/Constant';
import {CheckLogin} from '@modules/Common/CommonUtility';

export const CreateNewEntity = (dispatch, obj) => {
    fetch(`${Constant.PathServer}/api/DMNhomDanhMuc/Create`, {
        ...
        .then((json) => {
            if (json.Status) {
                ...
                dispatch({
                    type: TypeActions.HASUPDATE_DMNHOM
                });
            } else {
...
export const OpenEditModalSV = (dispatch, id) => {
    fetch(`${Constant.PathServer}/api/DMNhomDanhMuc/GetById?id=${id}`)
        .then((response) => response.json())
        .then((json) => {
            if (json.Status) {
                dispatch({
                    type: TypeActions.DMNHOM_EDIT_OPEN,
                    entityObj: json.Data
                });
            } else {
                toast.error(json.MessageError);
...
export const EditNewEntity = (dispatch, obj) => {
    fetch(`${Constant.PathServer}/api/DMNhomDanhMuc/Edit`, {
        method: 'POST', // *GET, POST, PUT, DELETE, etc.
        mode: 'cors', // no-cors, *cors, same-origin
        cache: 'no-cache', // *default, no-cache, reload, force-cache, only-if-cached
        credentials: 'same-origin', // include, *same-origin, omit
        ...
        .then((json) => {
            if (json.Status) {
                toast.success('Cập nhật nhóm danh mục thành công');
                dispatch({
                    type: TypeActions.DMNHOM_EDIT_SAVE
                });
            } else {
                toast.error(json.MessageError);
            }
...
export const LoadEntity = (dispatch, objSearch) => {
    ...
    fetch(`${Constant.PathServer}/api/DMNhomDanhMuc/GetData`, {
        method: 'POST', // *GET, POST, PUT, DELETE, etc.
        mode: 'cors', // no-cors, *cors, same-origin
        cache: 'no-cache', // *default, no-cache, reload, force-cache, only-if-cached
        credentials: 'same-origin', // include, *same-origin, omit
...
export const OpenDetailModalSV = (dispatch, id) => {
    fetch(`${Constant.PathServer}/api/DMNhomDanhMuc/GetById?id=${id}`)
        ...
        .then((json) => {
            if (json.Status) {
                dispatch({
                    type: TypeActions.DMNHOM_OPEN_VIEWDETAIL,
                    entityObj: json.Data
                });
            } else {
                toast.error(json.MessageError);
...
export const DeleteEntity = (dispatch, id) => {
    fetch(`${Constant.PathServer}/api/DMNhomDanhMuc/Delete?id=${id}`, {
        method: 'POST', // *GET, POST, PUT, DELETE, etc.
        mode: 'cors', // no-cors, *cors, same-origin
        cache: 'no-cache', // *default, no-cache, reload, force-cache, only-if-cached
        credentials: 'same-origin', // include, *same-origin, omit
...
export const DeleteMultiEntity = (dispatch, id) => {
    fetch(`${Constant.PathServer}/api/DMNhomDanhMuc/DeleteMulti?id=${id}`, {
        method: 'POST', // *GET, POST, PUT, DELETE, etc.
        mode: 'cors', // no-cors, *cors, same-origin
        cache: 'no-cache', // *default, no-cache, reload, force-cache, only-if-cached
        credentials: 'same-origin', // include, *same-origin, omit
