import * as TypeActions from '@app/store/ActionType/ModuleTypeAction';
...
export const CreateNewEntity = (dispatch, obj) => {
    fetch(`${Constant.PathServer}/api/Module/Create`, {
        ...
        .then((json) => {
            if (json.Status) {
                ...
                dispatch({
                    type: TypeActions.HASUPDATE_MODULE
                });
            } else {
...
export const OpenEditModalSV = (dispatch, id) => {
    fetch(`${Constant.PathServer}/api/Module/GetDtoById?id=${id}`, {
        ...
        .then((json) => {
            if (json.Status) {
                dispatch({
                    type: TypeActions.MODULE_EDIT_OPEN,
                    entityObj: json.Data
                });
            } else {
                toast.error(json.MessageError);
...
export const EditNewEntity = (dispatch, obj) => {
    fetch(`${Constant.PathServer}/api/Module/Edit`, {
        method: 'POST', // *GET, POST, PUT, DELETE, etc.
        mode: 'cors', // no-cors, *cors, same-origin
        cache: 'no-cache', // *default, no-cache, reload, force-cache, only-if-cached
        credentials: 'same-origin', // include, *same-origin, omit
        ...
        .then((json) => {
            if (json.Status) {
                ...
                dispatch({
                    type: TypeActions.MODULE_EDIT_SAVE
                });
            } else {
                toast.error(json.MessageError);
            }
...
export const LoadEntity = (dispatch, objSearch) => {
    ...
    fetch(`${Constant.PathServer}/api/Module/GetDanhSach`, {
        method: 'POST', // *GET, POST, PUT, DELETE, etc.
        mode: 'cors', // no-cors, *cors, same-origin
        cache: 'no-cache', // *default, no-cache, reload, force-cache, only-if-cached
        credentials: 'same-origin', // include, *same-origin, omit
...
export const OpenDetailModalSV = (dispatch, id) => {
    fetch(`${Constant.PathServer}/api/Module/GetDtoById?id=${id}`, {
        ...
        .then((json) => {
            if (json.Status) {
                dispatch({
                    type: TypeActions.MODULE_OPEN_VIEWDETAIL,
                    entityObj: json.Data
                });
            } else {
                toast.error(json.MessageError);
...
export const DeleteEntity = (dispatch, id) => {
    fetch(`${Constant.PathServer}/api/Module/Delete?id=${id}`, {
        method: 'POST', // *GET, POST, PUT, DELETE, etc.
        mode: 'cors', // no-cors, *cors, same-origin
        cache: 'no-cache', // *default, no-cache, reload, force-cache, only-if-cached
        credentials: 'same-origin', // include, *same-origin, omit
...
export const DeleteMultiEntity = (dispatch, id) => {
    fetch(`${Constant.PathServer}/api/Module/DeleteMulti?id=${id}`, {
        method: 'POST', // *GET, POST, PUT, DELETE, etc.
        mode: 'cors', // no-cors, *cors, same-origin
        cache: 'no-cache', // *default, no-cache, reload, force-cache, only-if-cached
        credentials: 'same-origin', // include, *same-origin, omit
